 ...
 * -Support for storing collected names in a local json-formatted textfile.
 *  Should be faster and also minimizes the risk of hitting the ip-based api-limit of YQL.
 * 
 * by Hampus Nordin
			...
			if (artnr == parseInt(artnr)) {
				...
				$.get(YQLstring(artnr), function(data) {
					...
					if (data != '' && data.query.results.results.h1.span != null) {
						...
						name = nameFormat(Array(d1,d2),o.nameFormat);
